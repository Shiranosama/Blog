(() => {
  // ns-hugo-imp:E:\WorkSpace\Shirano\Shirano\themes\FixIt\assets\js\core\banner.ts
  ...
  // ns-hugo-imp:E:\WorkSpace\Shirano\Shirano\themes\FixIt\assets\js\utils\animation.ts
  ...
  // ns-hugo-imp:E:\WorkSpace\Shirano\Shirano\themes\FixIt\assets\js\utils\dom.ts
  function isRTL() {
  ...
  // ns-hugo-imp:E:\WorkSpace\Shirano\Shirano\themes\FixIt\assets\js\utils\file.ts
  ...
  // ns-hugo-imp:E:\WorkSpace\Shirano\Shirano\themes\FixIt\assets\js\utils\media.ts
  function isMobile() {
  ...
  // ns-hugo-imp:E:\WorkSpace\Shirano\Shirano\themes\FixIt\assets\js\utils\string.ts
  ...
  // ns-hugo-imp:E:\WorkSpace\Shirano\Shirano\themes\FixIt\assets\js\utils\theme.ts
  ...
  // ns-hugo-imp:E:\WorkSpace\Shirano\Shirano\themes\FixIt\assets\js\utils\tooltip.ts
  function flashTooltip(el, message, duration = 3e3, clearPending = false) {
  ...
  // ns-hugo-imp:E:\WorkSpace\Shirano\Shirano\themes\FixIt\assets\js\utils\validate.ts
  function isValidDate(date) {
    return date instanceof Date && !Number.isNaN(date.getTime());
  }

  // ns-hugo-imp:E:\WorkSpace\Shirano\Shirano\themes\FixIt\assets\js\modules\code.ts
  ...
  // ns-hugo-imp:E:\WorkSpace\Shirano\Shirano\themes\FixIt\assets\js\modules\content.ts
  ...
  var ContentModule = class {
    ...
    initCollectionSort() {
      document.querySelectorAll(".collection-sort-toggle").forEach(($btn) => {
        if ($btn.dataset.init)
          return;
        $btn.dataset.init = "true";
        const $details = $btn.closest(".collection-details");
        const $list = $details?.querySelector(".collection-list");
        const $nav = $details?.querySelector(".collection-nav-simple");
        if (!$list || !$nav)
          return;
        let isAsc = true;
        $btn.addEventListener("click", (e) => {
          ...
          const $counter = $nav.querySelector(".text-secondary:not(.collection-nav-item)");
          if ($counter && activeIdx >= 0) {
            $counter.textContent = `${activeIdx + 1}/${$items.length}`;
          }
          const $navItems = $nav.querySelectorAll(".collection-nav-item");
          ...
          const $nextItem = activeIdx >= 0 && activeIdx < $items.length - 1 ? $items[activeIdx + 1].querySelector("a") : null;
          if ($navItems[1]) {
            if ($nextItem) {
              const $link = document.createElement("a");
    ...
    initTooltip() {
      ...
      CellTooltip2.initAll("li[data-task] > span[title]", { placement: inlineEnd });
      ...
      CellTooltip2.initAll(".collection-sort-toggle[title]", { placement: "bottom" });
      this.#initFootnotes();
    }
    /**
  ...
  // ns-hugo-imp:E:\WorkSpace\Shirano\Shirano\themes\FixIt\assets\js\modules\core.ts
  ...
  // ns-hugo-imp:E:\WorkSpace\Shirano\Shirano\themes\FixIt\assets\js\modules\encryption.ts
  ...
  // ns-hugo-imp:E:\WorkSpace\Shirano\Shirano\themes\FixIt\assets\js\modules\events.ts
  ...
  // ns-hugo-imp:E:\WorkSpace\Shirano\Shirano\themes\FixIt\assets\js\modules\menu.ts
  ...
  // ns-hugo-imp:E:\WorkSpace\Shirano\Shirano\themes\FixIt\assets\js\modules\misc.ts
  ...
  // ns-hugo-imp:E:\WorkSpace\Shirano\Shirano\themes\FixIt\assets\js\modules\pwa.ts
  var PWAModule = class {
    #core;
    constructor(core) {
      this.#core = core;
  ...
  // ns-hugo-imp:E:\WorkSpace\Shirano\Shirano\themes\FixIt\assets\js\modules\search\engines\algolia.ts
  ...
  // ns-hugo-imp:E:\WorkSpace\Shirano\Shirano\themes\FixIt\assets\js\modules\search\engines\cse.ts
  ...
  // ns-hugo-imp:E:\WorkSpace\Shirano\Shirano\themes\FixIt\assets\js\modules\search\engines\fuse.ts
  ...
  // ns-hugo-imp:E:\WorkSpace\Shirano\Shirano\themes\FixIt\assets\js\modules\search\engines\pagefind.ts
  ...
  // ns-hugo-imp:E:\WorkSpace\Shirano\Shirano\themes\FixIt\assets\js\modules\search\index.ts
  ...
  // ns-hugo-imp:E:\WorkSpace\Shirano\Shirano\themes\FixIt\assets\js\modules\theme.ts
  ...
  // ns-hugo-imp:E:\WorkSpace\Shirano\Shirano\themes\FixIt\assets\js\modules\toc.ts
  var TOC_CONTAINER_IDS = ["toc-content-auto", "toc-content-static", "toc-content-drawer"];
  var TocModule = class {
    #activeTocId = null;
    #previousActiveLinks = /* @__PURE__ */ new Map();
    #headingOffsets = [];
    ...
    #cacheHeadingOffsets() {
      const $headingElements = document.querySelectorAll(".heading-element[id]");
     ...
     * @param activeId - The id of the currently active heading.
     */
    #scrollActiveTocLinkIntoView($tocRoot, activeId) {
    ...
    #syncTocLayout() {
      document.querySelector("#nav-drawer-button")?.classList.toggle("hidden", !isTocStatic());
    ...
    #initTocDrawer() {
      const dialog = document.querySelector("#nav-dialog");
      const openButton = document.querySelector("#nav-drawer-button");
      if (!dialog || !openButton)
        return;
      const closeButton = dialog.querySelector(".nav-close-btn");
  ...
  // ns-hugo-imp:E:\WorkSpace\Shirano\Shirano\themes\FixIt\assets\js\core\public-api.ts
  var PublicAPI = class {
    core;
    theme;
    code;
